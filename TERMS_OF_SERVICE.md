...
The App, including its design, features, and functionality, is owned by MINORMEND CONSTRUCTION PRIVATE LIMITED and is protected by copyright, trademark, and other intellectual property laws.
...
TO THE MAXIMUM EXTENT PERMITTED BY LAW, MINORMEND CONSTRUCTION PRIVATE LIMITED SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS OR REVENUES, WHETHER INCURRED DIRECTLY OR INDIRECTLY, OR ANY LOSS OF DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES.
...
We may terminate or suspend your access to the App at any time, with or without cause or notice, for any reason.
...
*These terms of service are effective as of the date listed above and apply to all versions of the Checkly application.*
